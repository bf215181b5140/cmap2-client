  ...
  return (<Page flexDirection={'column'}>
    <Segment>
      ...
      <TextButton text={'error'}
                  onClick={() => addNotification('error', 'Integer commodo risus id neque iaculis consequat. Nam ligula diam, dapibus id posuere nec, consectetur eu metus. Nam ligula diam, dapibus id posuere nec, consectetur eu metus.')} />
