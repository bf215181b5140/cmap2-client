  ...
  if (item?.type === 'button' && itemButton) {
    return (<QuickEditToolbarStyled>
      ...
      <div>
        ...
        <IconButton role={'edit'} size={'small'} tooltip={'Detail edit'} onClick={() => navigate(`/website/layouts/${layout?.id}/${itemGroup?.id}/${itemButton?.id}`)} />
        <hr />
    ...
    return (<QuickEditToolbarStyled>
      ...
      <div>
        ...
        <IconButton role={'edit'} size={'small'} tooltip={'Detail edit'} onClick={() => navigate(`/website/layouts/${layout?.id}/${itemGroup?.id}`)} />
        <hr />
